...
class ProfileFollowersViewModel : ViewModel() {
            ...
            object : Callback<List<GithubUser>> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Log.e(ProfileFollowersViewModel.TAG, "onFailure: ${response.message()}")
                    }
                }
                ...
                override fun onFailure(
                    ...
                    Log.e(ProfileFollowersViewModel.TAG, "onFailure: ${t.message}")
                }
            },
        )
    }
